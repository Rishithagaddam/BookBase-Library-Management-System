...
const FacultyFeedback = () => {
    ...
    const fetchFeedbacks = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:5000/api/faculty/feedbacks?facultyId=${user.facultyId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem('user'));
            const response = await axios.post('http://localhost:5000/api/faculty/feedback', {
                ...formData,
